...
from httpx import AsyncClient  # Import AsyncClient for HTTP connection pooling
...
async def generate_pdf(user_data_list, customer):
    async with AsyncClient() as client:  # Use AsyncClient for HTTP connection pooling
        ...
        for user_data in user_data_list:
            ...
            # Optimize image size and format if necessary
            # Use a CDN for serving images if necessary
